...
static const struct swl_icon_def default_icons[] = {
	{ SWL_ICON_TERMINAL, "TSWL",        "tswl" },
	{ SWL_ICON_EDITOR,   "SWLPAD",      "swlpad" },
	{ SWL_ICON_FOLDER,   "ARQUIVOS",    "swlfiles" },
	{ SWL_ICON_BOOK,     "SEBRE",       "sebre" },
	{ SWL_ICON_CONFIG,   "CONFIG",      "swlconfig" },
	{ SWL_ICON_CHIP,     "DRIVERS",     "swldrivers" },
	{ SWL_ICON_NETWORK,  "REDE",        "swlnet" },
	{ SWL_ICON_MONITOR,  "SISTEMA",     "swlsysinfo" },
	{ SWL_ICON_MEDIA,    "MEDIAPLAYER", "swlmedia" },
	{ SWL_ICON_IMAGE,    "IMAGENS",     "swlimages" },
	{ SWL_ICON_GAME,     "JOGOS",       "swlgames" },
	{ SWL_ICON_ARCHIVE,  "COMPACTAR",   "swlarchive" },
	{ SWL_ICON_TRASH,    "LIXEIRA",     "swltrash" },
};
