...
static void server_cursor_button(struct wl_listener *listener, void *data) {
	...
	wl_list_for_each(t_iter, &server->toplevels, link) {
		...
		case SWL_DECO_MAXIMIZE:
			/* TODO: alternar maximizado/restaurado com estado salvo. */
			wlr_xdg_surface_schedule_configure(t_iter->xdg_toplevel->base);
			return;
		case SWL_DECO_MINIMIZE:
			/* TODO: esconder a janela e mantê-la só na taskbar. */
			return;
		case SWL_DECO_DRAG:
