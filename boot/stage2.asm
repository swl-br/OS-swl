...
INITRD_TOP    equ 0x17000000 ; 368MB — topo seguro com -m 512 (511MB úteis)
...
.have_setup_sects:
    ...
    ; -- carrega o initrd no TOPO da RAM (endereço alto e fixo) --
    ; Motivo: o kernel se autodescomprime a partir de 1MB e o vmlinux
    ; resultante (~20-30MB) sobrescreve um initrd carregado logo após o
    ; kernel. Sintoma: "Initramfs unpacking failed: uncompression error"
    ; só com initrds grandes (o de 13MB sobrevivia por terminar antes da
    ; área pisada). Bootloaders reais (GRUB) fazem o mesmo: initrd no alto.
