...
| S1 | **App Configurações (Claude)** — casca 12 seções entregue (só Sobre funcional); AGUARDANDO `apps/swlappkit/` (menubar M1) que falta na entrega — sem ela não compila. sysinfo parsers verificados (ASan ok, sistema real). | Claude |
