...
| T5 | **TSWL: seleção com mouse + copiar/colar** | CONCLUÍDA em 2026-09-09: pacote fix-t4-t5 (Grok) — dirty-row + barra T1 restaurada + seleção/highlight + forward decls; build limpo, T5/R-11/R-14 OK no sanitizer.  (duplo-clique/palavra pendente — aviso `2026-09-10-aviso-t5word.md`) | tswl |
