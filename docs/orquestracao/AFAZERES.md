...
| W1 | **TSWL deforma no resize: fix geometria aplicado, validar no QEMU** — dims por slot + memset + mínimos integrados. Falta teste real: redimensionar com TSWL aberto e confirmar. | QEMU/teste. |
